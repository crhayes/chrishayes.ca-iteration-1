...
const Icon = styled.a`
  ...
  &:nth-of-type(1) {
    animation: ${iconAnimation} 0.2s 0.7s forwards;
  }
  &:nth-of-type(2) {
    animation: ${iconAnimation} 0.2s 0.65s forwards;
  }
  &:nth-of-type(3) {
    animation: ${iconAnimation} 0.2s 0.6s forwards;
  }
  &:nth-of-type(4) {
    animation: ${iconAnimation} 0.2s 0.55s forwards;
  }
  &:nth-of-type(5) {
    animation: ${iconAnimation} 0.2s 0.5s forwards;
  }
`
...
const SocialIcons: React.FC<Props> = ({ className }) => (
  <Icons className={className}>
    <Icon href="https://github.com/crhayes" target="_blank" rel="noopener">
      <svg
    ...
    <Icon
      href="https://www.linkedin.com/in/crhayes/"
      target="_blank"
      rel="noopener"
    >
      <svg
    ...
    <Icon href="https://twitter.com/crhayes_" target="_blank" rel="noopener">
